    ...
    return (
        <BugDetailsCard
            ...
            items={[
                {
                    name: "Remote Unit",
                    value: stats.data?.name ? stats.data?.name : "NOT CONNECTED",
                },
                {
                    name: "Call time",
                ...
                {
                    name: "RX Rate",
                    value: stats.data?.effRxBitrate ? formatBps(stats.data?.effRxBitrate) : "",
                },
                {
                    name: "RX Overhead",
                    value: stats.data?.rxOverhead ? formatBps(stats.data?.rxOverhead) : "",
                },
                {
                    name: "RX Delay",
                    value: stats.data?.delayIn ? `${stats.data?.delayIn} ms` : "",
                },
                {
                    name: "TX Rate",
                    value: stats.data?.effTxBitrate ? formatBps(stats.data?.effTxBitrate) : "",
                },
                {
                    name: "TX Overhead",
                    value: stats.data?.txOverhead ? formatBps(stats.data?.txOverhead) : "",
                },
                {
                    name: "TX Delay",
                    value: stats.data?.delayOut ? `${stats.data?.delayOut} ms` : "",
                },
                {
                    name: "Frame Loss",
                    value:
