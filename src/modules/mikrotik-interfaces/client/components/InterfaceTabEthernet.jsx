            ...
            <Grid item xs={12}>
                <BugDetailsTable
                    items={[
                        {
                            name: "Status",
                            value: iface.data?.linkstats?.status,
                        },
                        {
                            name: "Auto Negotiation",
                            value: iface.data?.linkstats?.["auto-negotiation"],
                        },
                        {
                            name: "Negotiated Rate",
                            value: iface.data?.linkstats?.rate,
                        },
                        {
                            name: "Full Duplex?",
                            value: iface.data?.linkstats?.["full-duplex"] ? "yes" : "no",
                        },
                        {
                            name: "TX Flow Control?",
                            value: iface.data?.linkstats?.["tx-flow-control"] ? "yes" : "no",
                        },
                        {
                            name: "RX Flow Control?",
                            value: iface.data?.linkstats?.["rx-flow-control"] ? "yes" : "no",
                        },
                        {
