...
export default function GroupButtons({
    ...
    const handleGroupButtonClicked = (groupIndex) => {
        ...
        if (groupType === "transmitter") {
            navigate(`/panel/${panelId}${editText}/${groupIndex}/${recevierIndex}`);
        } else {
            navigate(`/panel/${panelId}${editText}/${transmitterIndex}/${groupIndex}`);
        }
    };
    ...
    const handleDragEnd = async (event) => {
        ...
        if (oldIndex !== newIndex) {
            ...
            const editText = editMode ? "/edit" : "";
            if (groupType === "transmitter") {
                navigate(`/panel/${panelId}${editText}/${newIndex}/${recevierGroup}`);
            } else {
                navigate(`/panel/${panelId}${editText}/${transmitterGroup}/${newIndex}`);
            }
        }
    };
