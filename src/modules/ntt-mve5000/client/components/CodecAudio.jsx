                ...
                items={[
                    {
                        ...
                        value: (
                            <BugSelect
                                ...
                                onChange={(event) =>
                                    onChange({
                                        audio_0_EncAudioFormat: parseInt(event.target.value),
                                    })
                                }
                                options={[
                                    { id: 0, label: "None" },
                    ...
                    },
                    {
                        ...
                        value: (
                            <BugSelect
                                ...
                                onChange={(event) =>
                                    onChange({
                                        audio_0_EncAudioRate2Ch: parseInt(event.target.value),
                                    })
                                }
                                options={[
                                    { id: 0, label: "64kbps" },
                ...
                items={[
                    {
                        ...
                        value: (
                            <BugSelect
                                ...
                                onChange={(event) =>
                                    onChange({
                                        audio_1_EncAudioFormat: parseInt(event.target.value),
                                    })
                                }
                                options={[
                                    { id: 0, label: "None" },
                    ...
                    },
                    {
                        ...
                        value: (
                            <BugSelect
                                ...
                                onChange={(event) =>
                                    onChange({
                                        audio_1_EncAudioRate2Ch: parseInt(event.target.value),
                                    })
                                }
                                options={[
                                    { id: 0, label: "64kbps" },
