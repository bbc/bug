...
module.exports = async function (config, snmpAwait) {
    ...
    if (!interfaces) {
        console.log("ciscoc1300-fetchinterfacedetails: no interfaces found in db - waiting ...");
        await delay(5000);
    } else {
        ...
        console.log(`ciscoc1300-fetchinterfacedetails: got details for ${interfaces.length} interface(s) - updating db`);
